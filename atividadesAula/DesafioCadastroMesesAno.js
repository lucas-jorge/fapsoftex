...
while (status === 1) {
  ...
  let op = readline.question("Digite a opção desejada: ");
...
function alterar() {
  ...
  let novoValor = readline.question("Informe o novo conteúdo: ");
...
function excluirMes() {
  ...
  listarMes();
  let mesExcluir = readline.question("Escolha o registro a ser excluído: ");
